!function() {
    ...
    function s(t) {
        ...
        return n.invert = function(n, a) {
            ...
            } while (Math.abs(e) > sa && --u > 0);var l = Math.sin(i);
    ...
    function v(t) {
        function n(t, n) {
            var e = Math.cos(n)
              , o = Math.cos(t /= 2);
            return [(1 + e) * Math.sin(t), i + Math.sin(n) * r - (1 + e) * a * o]
        }
        var a = Math.sin(t)
          , r = Math.cos(t)
          , e = t > 0 ? 1 : -1
        ...
        return n.invert = function(t, n) {
            ...
            do {
                ...
                h -= y,
                u -= S
            } while ((Math.abs(y) > sa || Math.abs(S) > sa) && --M > 0);return e * u > -Math.atan2(Math.cos(h), o) - .001 ? [2 * h, u] : null
        }
        ,
        n
    }
    function l() {
        function t(t) {
            for (var n = [], e = a * (1 - 1e-6), o = a * (90 - 1e-6), i = -180 * a; 180 > a * i; i += o)
                n.push([i, o]);
            for (i -= o; a * (i -= e) > -180; )
                n.push([i, a * -Math.atan2(Math.cos(i * ga / 2), r) * da]);
            return n.push(n[0]),
            t.clipPolygon([n])
        }
        var n = fa / 9
          ...
          , e = pa(v)
          , o = e(n);
        return o.parallel = function(o) {
            return arguments.length ? (r = Math.tan((a = (n = o * fa / 180) > 0 ? 1 : -1) * n),
            t(e(n))) : n / fa * 180
        }
        ,
        t(o)
    ...
    function S() {
        ...
        a.stream = function(n) {
            ...
            M.sphere = function() {
                s.polygonStart(),
                s.lineStart();
                for (var n = 0, a = 360 / t, r = 2 * fa / t, u = 90 - 180 / t, M = va; t > n; ++n,
                u -= a,
                M -= r)
                    s.point(Math.atan2(i * Math.cos(M), o) * da, h(i * Math.sin(M)) * da),
    ...
    function Q(t) {
        return function(n) {
            ...
            while (Math.abs(a) > sa && --e > 0);return n / 2
        }
    }
    function R(t, n, a) {
        function r(a, r) {
    ...
    function k(t) {
        function n(n, a) {
            for (var r = Math.sin(a), e = Math.cos(a), o = new Array(3), M = 0; 3 > M; ++M) {
                var s = t[M];
                if (o[M] = z(a - s[1], s[3], s[2], e, r, n - s[0]),
                !o[M][0])
                    return s.point;
                o[M][1] = F(o[M][1] - s.v[1])
            }
        ...
        r = a)
            a = t[e],
            r.v = z(a[1] - r[1], r[3], r[2], a[3], a[2], a[0] - r[0]),
            r.point = [0, 0];
    ...
    function N(t, n) {
        for (var a = (1 + va) * Math.sin(n), r = 0, e = 1 / 0; 10 > r && Math.abs(e) > sa; r++)
            n -= e = (n + Math.sin(n) - a) / (1 + Math.cos(n));
        return a = Math.sqrt(2 + fa),
    ...
    function X(t, n, a, r, e, o, i, h) {
        ...
        u.invert = function(u, s) {
            ...
            do {
                ...
                mcosα = m * cosα,
                msinα = m * sinα,
                dαdφ = v / fa * (1 / M(1 - xB2 / y)) * (dxBdφ * m - b * dmdφ) / y,
                fx = msinα - u,
            ...
            } while ((Math.abs(c) > sa || Math.abs(f) > sa) && --g > 0);return [v, l]
        }
        ,
        u
    }
        ...
        function a(n) {
            ...
            : function(n, a) {
                var e = n > 0 ? -.5 : .5
                  , o = t.invert(n + e * r, a)
                  , i = o[0] - e * fa;
                return -fa > i ? i += 2 * fa : i > fa && (i -= 2 * fa),
                o[0] = i,
                o
            }
            ),
    ...
    function rn(t, n) {
        ...
        if (n >= 1 - sa)
            ...
            e = 1 / r,
            i = r * d(t),
            [o + a * (i - t) / (r * r), e - a * o * e * (i - t), e + a * o * e * (i + t), 2 * Math.atan(Math.exp(t)) - va + a * (i - t) / r];
        var u = [1, 0, 0, 0, 0, 0, 0, 0, 0]
          , s = [Math.sqrt(n), 0, 0, 0, 0, 0, 0, 0, 0]
          , c = 0;
        for (r = Math.sqrt(1 - n),
        i = 1; Math.abs(s[c] / u[c]) > sa && 8 > c; )
            a = u[c++],
            s[c] = .5 * (a - r),
            u[c] = .5 * (a + r),
            r = M(a * r),
    ...
    function on(t, n) {
        if (!n)
            return t;
        if (1 === n)
            return Math.log(Math.tan(t / 2 + fa / 4));
    ...
    function fn() {
        ...
        ,
        a.rotate = function(n) {
            return arguments.length ? (r.call(a, [n[0], n[1] - t / fa * 180]),
            o.origin([-n[0], -n[1]]),
            a) : (n = r.call(a),
            n[1] += t / fa * 180,
            n)
    ...
    function vn(t, n) {
        ...
        1 === n ? ka : 1 / 0 === n ? gn : (a.invert = function(a, r) {
    ...
    function wn(t) {
        function n(n, e) {
            ...
            if (f && 2 > f) {
                ...
                } while (Math.abs(v) > ca && --g > 0);h = i * Math.sqrt(w),
                u = n * p / fa
            } else
                h = i * (t + f),
                u = n * o / fa;
        ...
        var a, r = 1 + t, e = Math.sin(1 / r), o = h(e), i = 2 * Math.sqrt(fa / (a = fa + 4 * o * r)), M = .5 * i * (r + Math.sqrt(t * (2 + t))), s = t * t, c = r * r;
        return n.invert = function(t, n) {
            var e = t * t + (n -= M) * n
              , f = (1 + c - e / (i * i)) / (2 * r)
              , v = u(f)
    ...
    function mn(t, n) {
        return n > -za ? (t = ya(t, n),
        t[1] += Ba,
        t) : E(t, n)
    }
    function yn(t, n) {
        return Math.abs(n) > za ? (t = ya(t, n),
        t[1] -= n > 0 ? Ba : -Ba,
        t) : E(t, n)
    }
    function Sn(t, n) {
    ...
    function _n(t) {
        ...
        return n.invert = function(n, r) {
            ...
            do {
                ...
                o -= g = (c * v + f * l) / b,
                i -= d = (f * v - c * l) / b
            } while (Math.abs(g) + Math.abs(d) > sa * sa && --e > 0);if (e) {
    ...
    function An(t, n) {
        for (var a, r = Math.sqrt(6 / (4 + fa)), e = (1 + fa / 4) * Math.sin(n), o = n / 2, i = 0; 25 > i && (o -= a = (o / 2 + Math.sin(o) - e) / (.5 + Math.cos(o)),
        !(Math.abs(a) < sa)); i++)
            ;
    ...
    function Dn(t) {
        ...
        return n.invert = function(n, r) {
            ...
            } while (Math.abs(e) > sa && --M > 0);var v = n * (s = Math.tan(i))
    ...
    function Ln(t, n) {
        var a, r = Math.min(18, 36 * Math.abs(n) / fa), e = Math.floor(r), o = r - e, i = (a = Ga[e])[0], h = a[1], u = (a = Ga[++e])[0], M = a[1], s = (a = Ga[Math.min(19, ++e)])[0], c = a[1];
    ...
    function Nn() {
        ...
        a.points = function(a) {
            ...
            var e = d3.geo.interpolate(a[0], a[1])
              ...
              , u = .5 * e.distance
              , M = -h(Math.sin(i[1] * ga) / Math.sin(u));
            return i[0] > 0 && (M = fa - M),
            r.call(i, [-o[0], -o[1], -M * da]),
            n(2 * u)
        }
        ,
        a
    ...
    function Wn(t, n) {
        ...
        var a = Math.abs(n / va)
          , r = h(a);
        if (Math.abs(t) < sa || Math.abs(Math.abs(n) - va) < sa)
            return [0, i(n) * fa * Math.tan(r / 2)];
        var e = Math.cos(r)
    ...
    d3.geo.interrupt = function(t) {
        ...
        var i, h = [[[[-fa, 0], [0, va], [fa, 0]]], [[[-fa, 0], [0, -va], [fa, 0]]]];
    ...
    f.invert = function(t, n) {
        if (!(t * t + 4 * n * n > fa * fa + sa)) {
            ...
            do {
                ...
                a -= R,
                r -= T
            } while ((Math.abs(R) > sa || Math.abs(T) > sa) && --e > 0);return [a, r]
        }
    }
    ,
    ...
    m.invert = function(t, n) {
        if ((r = Math.abs(n)) < wa)
            return [t, 2 * Math.atan(Math.exp(n)) - va];
        var a, r, e = Math.sqrt(8), o = fa / 4, h = 25;
        do {
            var u = Math.cos(o / 2)
              , M = Math.tan(o / 2);
            o -= a = (e * (o - fa / 4) - Math.log(M) - r) / (e - .5 * u * u / M)
        } while (Math.abs(a) > ca && --h > 0);return [t / (Math.cos(o) * (e - 1 / Math.sin(o))), i(n) * o]
    }
    ,
    ...
    T.invert = function(t, n) {
        ...
        do
            ...
            i -= a = (Math.sin(2 * i) + 2 * i - fa * Math.sin(r)) / (2 * Math.cos(2 * i) + 2 + fa * Math.cos(r) * Math.SQRT2 * Math.cos(i));
        while (Math.abs(a) > sa && --h > 0);return r = o - Math.SQRT2 * Math.sin(i),
    ...
    U.invert = function(t, n) {
        ...
        do {
            ...
            var C = (Q * F - S * G) / j
              , D = (S * A - Q * B) / j;
            r -= C,
            e = Math.max(-va, Math.min(va, e - D))
        } while ((Math.abs(C) > sa || Math.abs(D) > sa) && --o > 0);return Math.abs(Math.abs(e) - va) < sa ? [0, e] : o && [r, e]
    }
    ;
    ...
    d3.geo.gilbert = function(t) {
        ...
        return t.invert && (n.invert = function(n) {
            return n = t.invert(n),
            n[0] *= 2,
            n[1] = 2 * Math.atan(Math.sin(n[1] * ga)) * da,
            n
        }
        ),
        n.stream = function(n) {
    ...
    Y.invert = function(t, n) {
        var a, r = t, e = n, o = 50;
        do {
            var i = e * e;
            e -= a = (e * (1 + i / 12) - n) / (1 + i / 4)
        } while (Math.abs(a) > sa && --o > 0);o = 50,
        t /= 1 - .162388 * i;
        do {
            var h = (h = r * r) * h;
            r -= a = (r * (.87 - 952426e-9 * h) - t) / (.87 - .00476213 * h)
        } while (Math.abs(a) > sa && --o > 0);return [r, e]
    }
    ,
    ...
    ,
    d3.geo.guyou = Z(hn),
    (d3.geo.hammerRetroazimuthal = fn).raw = sn;
    ...
    (d3.geo.healpix = pn).raw = bn,
    (d3.geo.hill = qn).raw = wn;
    ...
    xn.invert = function(t, n) {
        ...
        do {
            ...
            a -= d,
            r -= b
        } while ((Math.abs(d) > sa || Math.abs(b) > sa) && --e > 0);return e && [a, r]
    }
    ,
    ...
    (d3.geo.modifiedStereographic = zn).raw = _n,
    ...
    An.invert = function(t, n) {
        var a = Math.sqrt(6 / (4 + fa))
          , r = n / a;
        return Math.abs(Math.abs(r) - va) < sa && (r = 0 > r ? -va : va),
        [1.5 * t / (a * (.5 + Math.cos(r))), h((r / 2 + Math.sin(r)) / (1 + fa / 4))]
    }
    ,
    ...
    Gn.invert = function(t, n) {
        ...
        } while (Math.abs(a) > sa && --e > 0);return [t / (.8707 + (o = r * r) * (-.131979 + o * (-.013791 + o * o * o * (.003971 - .001529 * o)))), r]
    }
    ,
    ...
    Cn.invert = function(t, n) {
        ...
        } while (Math.abs(a) > sa && --o > 0);return M = Math.tan(e),
        [(Math.abs(n) < Math.abs(e + 1 / M) ? h(t * M) : i(t) * (u(Math.abs(t * M)) + va)) / Math.sin(e), e]
    }
    ,
    ...
    var Ga = [[.9986, -.062], [1, 0], [.9986, .062], [.9954, .124], [.99, .186], [.9822, .248], [.973, .31], [.96, .372], [.9427, .434], [.9216, .4958], [.8962, .5571], [.8679, .6176], [.835, .6769], [.7986, .7346], [.7597, .7903], [.7186, .8435], [.6732, .8936], [.6213, .9394], [.5722, .9761], [.5322, 1]];
        ...
        do {
            ...
            if (v >= 0 || 1 === o) {
                ...
                do
                    ...
                    h = Ga[o + 1][1],
                    u = Ga[Math.min(19, o + 2)][1],
                    r -= (l = (n >= 0 ? va : -va) * (h + v * (u - i) / 2 + v * v * (u - 2 * h + i) / 2) - n) * da;
                while (Math.abs(l) > ca && --g > 0);break
            }
        } while (--o >= 0);var d = Ga[o][0]
          , b = Ga[o + 1][0]
    ...
    (d3.geo.twoPointEquidistant = Nn).raw = Kn,
    (d3.geo.twoPointAzimuthal = Vn).raw = Un,
    Wn.invert = function(t, n) {
        if (Math.abs(n) < sa)
            return [t, 0];
        if (Math.abs(t) < sa)
            return [0, va * Math.sin(2 * Math.atan(n / fa))];
        var a = (t /= fa) * t
          , r = (n /= fa) * n
          , e = a + r
          , o = e * e
    ...
    Zn.invert = function(t, n) {
        ...
        do {
            ...
            o -= δ = w / q
        } while (δ > sa && --h > 0);return [i(t) * (Math.sqrt(r * r + 4) + r) * fa / 4, va * o]
    }
    ,
